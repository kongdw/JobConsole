 ...
 */
package cn.com.cis.plugins.scriptella;
...
/**
 * Implementation of {@link scriptella.execution.EtlExecutor} for Spring IoC container.
 * <p>This class exposes a set of configurable properties and provides
 * a {@link java.util.concurrent.Callable} invocation interface to avoid dependency on Scriptella
 * in application code.
 *
...
public class EtlExecutorBean extends EtlExecutor implements InitializingBean, BeanFactoryAware {
    private static final String BEAN_FACTORY_XML_PATH = "classpath:cn/com/cis/plugins/scriptella/beanFactory.xml";
