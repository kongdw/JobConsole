...
public interface ThreadPool {
     ...
     * 
     * @param task 实现了{@link java.util.concurrent.Callable}接口的异步任务
     * @return 异步任务执行的结果
     * @throws IllegalArgumentException 指定的任务（<code>task</code>）为null
     * @see #submit(java.util.concurrent.Callable, String)
     */
     ...
     * @return {@link java.util.concurrent.Future}列表。注：如果在指定的时间内，有任务没有执行完，在执行Future.get操作时将抛出{@link java.util.concurrent.CancellationException}。
     * @throws IllegalArgumentException 出现以下情况时抛出：
     * <ul>
     ...
     * </ul>
     * @see #invokeAll(java.util.Collection, long, java.util.concurrent.TimeUnit,java.lang.String)
     */
