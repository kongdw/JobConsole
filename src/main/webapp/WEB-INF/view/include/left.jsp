        ...
        <c:if test="${user.roleType eq '1'}">
            <li class="dark-nav">
                ...
                <ul id="jobList" class="collapse">
                    ...
                    <li class="">
                        <a href="${pageContext.request.contextPath}/layer/list">
                            <i class="icon-align-left"></i>
                            <span>层级管理</span>
                        </a>
                    </li>
                    <li class="">
                        <a href="${pageContext.request.contextPath}/database/list">
                            <i class="icon-leaf"></i>
                            <span>数据源管理</span>
                        </a>
                    </li>
                    <li class="">
                        <a href="${pageContext.request.contextPath}/databasetype/list">
                            <i class="icon-bookmark"></i>
                            <span>驱动管理</span>
                        </a>
                    </li>
                    <li class="">
                        <a href="${pageContext.request.contextPath}/parameter/glist">
                            <i class="icon-chevron-right"></i><span>全局参数管理</span>
                        </a>
                    </li>
                    <li class="">
