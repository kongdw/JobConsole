        ...
        <div class="row">
            ...
            <div id="breadcrumbs">
                ...
                <div class="breadcrumb-button">
                    <span class="breadcrumb-label"><i class="icon-edit"></i> 修改参数</span>
                    <span class="breadcrumb-arrow"><span></span></span>
                </div>
            </div>
        </div>
    ...
    <div class="container">
        <div class="widget-box">
            <div class="widget-box-header">
                <div class="col-sm-2">
                    <div class="title"><i class="icon-edit">&nbsp;</i>修改参数</div>
                </div>
            </div>
            <div class="widget-box-content" style="padding:15px;">
                ...
                <form class="form-horizontal" role="form" action="/parameter/update" method="post">
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="hidden" name="refId" value="${parameterRef.id}"/>
                            <input disabled type="text" class="form-control" name="refName" placeholder="参数名称"
                                   data-toggle="tooltip"
                                   data-placement="left" value="${parameterRef.refName}" required="">
                        </div>
                        ...
                        <div class="col-sm-5">
                            <select class="form-control" name="returnType" required="">
                                ...
                                <c:forEach items="${parameterTypeList}" var="parameterType">
                                    <option <c:if
                                            test="${parameterType.code  eq parameterRef.returnType.code}"> selected </c:if>
                                            value="${parameterType.code}">${parameterType.description}</option>
                                </c:forEach>
                            </select>
                        </div>
                    </div>
                    <div class="form-group">
                        ...
                        <div class="col-sm-5">
                            <input type="text" class="form-control" name="defaultVal" placeholder="缺省值"
                                   data-toggle="tooltip" data-placement="left" value="${parameterRef.defaultVal}" required="">
                        </div>
                    </div>
                    <div class="form-group">
